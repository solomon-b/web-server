...
-- | Get session with minimal user data (id, email, password only)
-- For full user data with metadata, use Effects.Database.Queries.UserWithMetadata.getSessionFullUser
